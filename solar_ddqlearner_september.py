...
if __name__=='__main__':
    ...
    #agent = ddqlearner.DDQNAgent(env,n_episodes = 500, max_env_steps=300*8, modeldir=loadmodel,decay_rate = 0.9, learning_rate = learning_rate, layer_width=layer_width)
