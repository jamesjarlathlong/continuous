...
if __name__=='__main__':
    ...
    agent = ddqlearner.DDQNConvAgent(env,n_episodes = 2000, max_env_steps=300*8, modeldir=loadmodel,
                                decay_rate = 0.999999, learning_rate = learning_rate, layer_width=layer_width)
