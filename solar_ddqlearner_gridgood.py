...
if __name__=='__main__':
    ...
    #agent = ddqlearner.DDQNAgent(env,n_episodes = 5000, max_env_steps=300*8, modeldir=loadmodel,decay_finish = 0.9, learning_rate = learning_rate, layer_width=layer_width)
    ...
    naiveagent = simple_agent.SimpleNetworkAgent(env, n_episodes = 10, max_env_steps = 300*8, num_on=10)
    naiveagent.run()
