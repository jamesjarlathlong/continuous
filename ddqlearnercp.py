...
class DoubleDQNAgent:
    def __init__(self, env,n_episodes, max_env_steps=None, modeldir=None, learning_rate = 0.0001, decay_finish = 0.75, layer_width=64,checkpoint_name=None):
        self.env = env
        ...
        self.epsilon_delta = (self.epsilon-self.epsilon_min)/int(decay_finish*n_episodes*max_env_steps)
        ...
        if checkpoint_name:
            self.checkdir = 'tmp/{}'.format(checkpoint_name)
...
class DDQNAgent:
    def __init__(self, env,n_episodes, max_env_steps=None, modeldir=None, learning_rate = 0.0001, decay_rate = 0.999995, layer_width=64,checkpoint_name =None):
        self.env = env
        self.n_episodes = n_episodes
        self.state_size = len(flatten_state_withtime(env.observation_space.sample())[0])
        self.action_size = get_alt_action_size(self.env)
